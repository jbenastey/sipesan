...
<div class="container">
	...
	<div class="payment-success-title-area">
		...
		<p class="lead">Silahkan transfer ke rekening <b><?=$bank?></b> sebesar <b>Rp. <?=nominal($pesanan['keranjang_total'])?></b> sebelum 1x24 jam.</p>

			<p>Kemudian konfirmasi pembayaran DISINI.
		</p>
	</div>
