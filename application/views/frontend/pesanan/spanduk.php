					...
					<div class="box">
						<form class="forms-sample">
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										<input type="number" class="form-control" id="" placeholder="Panjang" required autocomplete="off">
									</div>
									<div class="col-md-6">
										<input type="number" class="form-control" id="" placeholder="Lebar" required autocomplete="off">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="">Tipe Bahan<span style="color: red">*</span> :</label><br>
								<select name="bahan" id="" class="form-control" required>
							...
							<div class="form-group">
								...
								<ul>
									<li>Biasa : Rp. 20.000 per meter</li>
									<li>Menengah : Rp. 30.000 per meter</li>
									<li>Bagus : Rp. 35.000 per meter</li>
								</ul>
							</div>
						</form>
					</div>
